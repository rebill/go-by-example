...
func main() {
	...
	// In order to use the values in the decoded map, we’ll need to cast them to
	// their appropriate type. For example here we cast the value in num to
	...
	// stream JSON encodings directly to os.Writers like os.Stdout or
