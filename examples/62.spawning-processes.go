...
func main() {
	...
	// write some input to it, read the resulting output, and finally wait for
	// the process to exit.
	...
	// if err != nil pattern for all of them. We also only collect the StdoutPipe
	// results, but you could collect the StderrPipe in exactly the same way.
